...
namespace eval ::optrace {
  variable script "E:/im_always_learning/E906_zcu/vivado_e906_zcu/vivado_e906_zcu.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet E:/im_always_learning/E906_zcu/vivado_e906_zcu/vivado_e906_zcu.runs/synth_1/design_1_wrapper.dcp
...
OPTRACE "Write Bitstream: pre hook" START { }
  set src_rc [catch { 
    puts "source E:/im_always_learning/E906_zcu/opene906-main/E906_RTL_FACTORY/gen_rtl/my.tcl"
  ...
  if {$src_rc} { 
    ...
    if { $tool_flow eq {SDx} } { 
      ...
      send_gid_msg -id 3 -ssname VPL_TCL -severity ERROR "sourcing script E:/im_always_learning/E906_zcu/opene906-main/E906_RTL_FACTORY/gen_rtl/my.tcl failed"
    } else {
      send_msg_id runtcl-1 status "$_RESULT"
      send_msg_id runtcl-2 status "sourcing script E:/im_always_learning/E906_zcu/opene906-main/E906_RTL_FACTORY/gen_rtl/my.tcl failed"
    }
    return -code error
  }
