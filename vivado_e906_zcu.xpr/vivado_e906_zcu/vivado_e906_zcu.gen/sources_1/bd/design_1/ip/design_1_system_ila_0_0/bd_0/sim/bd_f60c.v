...
module bd_f60c
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:ahblite:2.0 SLOT_1_AHBLITE HMASTLOCK" *) input SLOT_1_AHBLITE_hmastlock;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:ahblite:2.0 SLOT_1_AHBLITE HREADY" *) input SLOT_1_AHBLITE_hready;
  (* X_INTERFACE_INFO = "xilinx.com:interface:ahblite:2.0 SLOT_1_AHBLITE HRESP" *) input [1:0]SLOT_1_AHBLITE_hresp;
  ...
  wire SLOT_1_AHBLITE_hmastlock_1;
  wire [3:0]SLOT_1_AHBLITE_hprot_1;
  wire [31:0]SLOT_1_AHBLITE_hrdata_1;
  wire SLOT_1_AHBLITE_hready_1;
  wire [1:0]SLOT_1_AHBLITE_hresp_1;
  ...
  assign SLOT_1_AHBLITE_hmastlock_1 = SLOT_1_AHBLITE_hmastlock;
  assign SLOT_1_AHBLITE_hprot_1 = SLOT_1_AHBLITE_hprot[3:0];
  assign SLOT_1_AHBLITE_hrdata_1 = SLOT_1_AHBLITE_hrdata[31:0];
  assign SLOT_1_AHBLITE_hready_1 = SLOT_1_AHBLITE_hready;
  assign SLOT_1_AHBLITE_hresp_1 = SLOT_1_AHBLITE_hresp[1:0];
  ...
  bd_f60c_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe11(SLOT_1_AHBLITE_htrans_1),
        .probe12(SLOT_1_AHBLITE_hsize_1),
        .probe13(SLOT_1_AHBLITE_hrdata_1),
        .probe14(SLOT_1_AHBLITE_hresp_1),
        .probe15(SLOT_1_AHBLITE_hwrite_1),
        .probe16(SLOT_1_AHBLITE_hready_1),
        .probe17(SLOT_1_AHBLITE_haddr_1),
        .probe18(SLOT_1_AHBLITE_hwdata_1),
        .probe19(SLOT_1_AHBLITE_hprot_1),
        .probe2(SLOT_0_AHBLITE_hrdata_1),
        .probe20(SLOT_1_AHBLITE_hmastlock_1),
        .probe21(SLOT_1_AHBLITE_hburst_1),
